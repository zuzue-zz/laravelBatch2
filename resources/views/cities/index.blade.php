...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <a href="{{ route('cities.create') }}" class="btn btn-primary btn-sm rouned-0">Create</a>
        </div>
        <hr />
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="col-md-4 col-sm-8 mb-2">
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('cities.index') }}" id="btn-clear" class="btn btn-secondary btn-sm"><i
            ...
            <tbody>
                @foreach ($cities as $idx => $city)
                    <tr id="delete_{{ $city->id }}">
                        ...
                        <td>
                            <a href="{{ route('cities.edit', $city->id) }}" class="text-info"><i
                            ...
                            <form id="formdelete-{{ $idx }}" action="{{ route('cities.destroy', $city->id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
