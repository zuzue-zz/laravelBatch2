...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <a href="{{ route('countries.create') }}" class="btn btn-primary btn-sm rouned-0">Create</a>
        </div>
        <hr />
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="col-md-4 col-sm-8 mb-2">
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('countries.index') }}" id="btn-clear"
