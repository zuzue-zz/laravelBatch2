...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <a href="{{ route('regions.create') }}" class="btn btn-primary btn-sm rouned-0">Create</a>
        </div>
        <hr />
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="col-md-4 col-sm-8 mb-2">
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('regions.index') }}" id="btn-clear"
            ...
            <tbody>
                @foreach ($regions as $idx => $region)
                    <tr id="delete_{{ $region->id }}">
                        ...
                        <td>
                            <a href="{{ route('regions.edit', $region->id) }}" class="text-info"><i
                            ...
                            <form id="formdelete-{{ $idx }}" action="{{ route('regions.destroy', $region->id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
