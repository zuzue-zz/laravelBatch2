...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <a href="{{ route('townships.create') }}" class="btn btn-primary btn-sm rouned-0">Create</a>
        </div>
        <hr />
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="col-md-4 col-sm-8 mb-2">
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('townships.index') }}" id="btn-clear"
    ...
    <div class="col-md-12">
            ...
            <tbody>
                @foreach ($townships as $idx => $township)
                    <tr id="delete_{{ $township->id }}">
                        ...
                        <td>
                            <a href="{{ route('townships.edit', $township->id) }}" class="text-info"><i
                            ...
                            <form id="formdelete-{{ $idx }}"
                                action="{{ route('townships.destroy', $township->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
        ...
        {{ $townships->links('pagination::bootstrap-5') }}
