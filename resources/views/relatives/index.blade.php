...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <a href="{{ route('relatives.create') }}" class="btn btn-primary btn-sm rouned-0">Create</a>
        </div>
        <hr />
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form action="{{ route('relatives.index') }}" method="GET">
                        ...
                        <div class="row justify-content-end">
                            ...
                            <div class="col-md-4 col-sm-8 mb-2">
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('relatives.index') }}" id="btn-clear"
            ...
            <tbody>
                @foreach ($relatives as $idx => $relative)
                    <tr id="delete_{{ $relative->id }}">
                        ...
                        <td>
                            <a href="{{ route('relatives.edit', $relative->id) }}" class="text-info"><i
                            ...
                            <form id="formdelete-{{ $idx }}"
                                action="{{ route('relatives.destroy', $relative->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#bulkdelete-btn').click(function() {
                ...
                $.ajax({
                    url: '{{ route("relatives.bulkdeletes") }}',
                    type: "DELETE",
                    datatype: 'json',
                    data: {
